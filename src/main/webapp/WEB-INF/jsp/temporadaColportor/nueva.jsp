                ...
                <fieldset>
                    ...
                    <s:bind path="temporadaColportor.asociado">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                                ...
                                <span class="required-indicator">*</span>
                                <form:select id="asociadoId" path="asociado.id" items="${asociados}" itemLabel="username" itemValue="id" />
                    ...
                    <s:bind path="temporadaColportor.colportor">
                        <div class="control-group <c:if test='${not empty status.errorMessages}'>error</c:if>">
                                ...
                                <span class="required-indicator">*</span>
                                <form:select id="colportorId" path="colportor.id" items="${colportores}" itemLabel="username" itemValue="id" />
